...
public class DynArray<T> {
    ...
    public DynArray(int capacity) { // Konstruktor der ein Array mit 1 als max Kapazität anlegt
        size = 0;
        this.capacity = 1;
        dyn_array = (T[]) new Object[this.capacity]; // anlegen eines Arrays mit Kapazität 1
    }
